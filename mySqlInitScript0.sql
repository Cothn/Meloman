...
-- Schema meloman_db0
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `meloman_db0`;
USE `meloman_db0` ;

-- -----------------------------------------------------
-- Table `meloman_db0`.`user_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`user_role` (
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`genres`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`genres` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`title` ASC) )
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`track`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`track` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  ...
  CONSTRAINT `fk_track_genres1`
    ...
    REFERENCES `meloman_db0`.`genres` (`id`),
  CONSTRAINT `fk_track_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `meloman_db0`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
;
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_users_user_role1`
    FOREIGN KEY (`role_id`)
    REFERENCES `meloman_db0`.`user_role` (`id`),
  CONSTRAINT `fk_users_track1`
    FOREIGN KEY (`music_avatar_id`)
    REFERENCES `meloman_db0`.`track` (`id`))
ENGINE = InnoDB
;


-- -----------------------------------------------------
-- Table `meloman_db0`.`playlist`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`playlist` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`posts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`posts` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_posts_playlist1`
    ...
    REFERENCES `meloman_db0`.`playlist` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`comments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`comments` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_comments_posts1`
    FOREIGN KEY (`post_id`)
    REFERENCES `meloman_db0`.`posts` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`likes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`likes` (
  `user_id` INT NOT NULL,
  `post_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`playlist_track`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`playlist_track` (
  `playlist_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `meloman_db0`.`users_playlists`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `meloman_db0`.`users_playlists` (
  `playlist_id` INT NOT NULL,
  `user_id` INT NOT NULL,
